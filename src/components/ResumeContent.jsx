...
// Exact port of src/app/resume/page.js — no Next.js dependencies.

import { FaEnvelope, FaChevronDown, FaChevronUp, FaGithub, FaLinkedin } from "react-icons/fa";
import { motion } from "framer-motion";
import { useState, useEffect } from "react";

const cardVar  = { hover: { y: -3 },       tap: { scale: 0.98 } };
...
export default function ResumeContent() {
  ...
  const [expandedSections, setExpandedSections] = useState({ awards: true, clubs: true });
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-base-100 rounded-lg shadow-lg p-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 items-center">
            ...
            <motion.div whileHover={buttonVar.hover} whileTap={buttonVar.tap}
              className="tooltip" data-tip={copied.email ? "Copied!" : "Click to copy"}>
            ...
            {/* GitHub */}
            <motion.div whileHover={buttonVar.hover} whileTap={buttonVar.tap}
              className="tooltip" data-tip={copied.github ? "Copied!" : "Click to copy"}>
              <button onClick={() => handleCopy("github", "github.com/thatdudegrantt")}
                className="btn btn-outline btn-sm flex items-center gap-2 border-base-content hover:border-base-content">
            ...
            {/* LinkedIn */}
            <motion.div whileHover={buttonVar.hover} whileTap={buttonVar.tap}
              className="tooltip" data-tip={copied.linkedin ? "Copied!" : "Click to copy"}>
              <button onClick={() => handleCopy("linkedin", "linkedin.com/in/grant-polazzo")}
                className="btn btn-outline btn-sm flex items-center gap-2 border-base-content hover:border-base-content">
              ...
              {expandedSections.awards && (
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  ...
                  <li className="text-base-content">
                    GSU President's List Fall 2022 &amp; Dean's List Spring 2023
                  </li>
                </ul>
              )}
            </div>
            ...
            <div className="mt-3">
              ...
              {expandedSections.clubs && (
                <p className="text-base-content mt-2">
                  GT Developers, Video Games @ GT, GT Esports, &amp; multiple GT recreational sports clubs.
                </p>
              )}
            </div>
          </div>
        ...
        <div className="bg-base-100 rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-6">
            ...
            {/* Plankton CV */}
            <motion.div whileHover={cardVar.hover} whileTap={cardVar.tap}
              ...
              <div className="flex flex-wrap justify-between items-start mb-2 gap-1">
                <h3 className="text-xl font-bold text-base-content">PLANKTON COMPUTER VISION PROJECT</h3>
            ...
            <motion.div whileHover={cardVar.hover} whileTap={cardVar.tap}
              ...
              <div className="flex flex-wrap justify-between items-start mb-2 gap-1">
                <h3 className="text-xl font-bold text-base-content">
                  GAME BOY ADVANCE EMULATOR &amp; FROGGER CLONE
                </h3>
              ...
              <ul className="space-y-2 text-base-content">
                ...
                <li className="flex items-start"><span className="mr-2">•</span>
                  Developed Frogger game with custom collision detection and state machine architecture
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div whileHover={cardVar.hover} whileTap={cardVar.tap}
              ...
              <div className="flex flex-wrap justify-between items-start mb-2 gap-1">
                <h3 className="text-xl font-bold text-base-content">
                  AUDIOSCAPE JOURNEY (CUSTOM SPOTIFY WRAPPED)
                </h3>
              ...
              <ul className="space-y-2 text-base-content">
                <li className="flex items-start"><span className="mr-2">•</span>
                  Dynamic website leveraging Spotify API to generate &amp; display custom music listening data
                </li>
                <li className="flex items-start"><span className="mr-2">•</span>
                  Designed engaging animations, game logic, and integrated AI using Google's Gemini LLM
                </li>
              </ul>
            </motion.div>
        ...
        <div className="bg-base-100 rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-6">
            ...
            <motion.div whileHover={cardVar.hover} whileTap={cardVar.tap}
              ...
              <div className="flex flex-wrap justify-between items-start mb-2 gap-1">
                <h3 className="text-xl font-semibold text-base-content">
                  CITY OF ATLANTA, OFFICE OF THE MAYOR — EXECUTIVE INTERN
                </h3>
            ...
            <motion.div whileHover={cardVar.hover} whileTap={cardVar.tap}
              ...
              <div className="flex flex-wrap justify-between items-start mb-2 gap-1">
                <h3 className="text-xl font-semibold text-base-content">
                  JON OSSOFF FOR US SENATE — CAMPAIGN VOLUNTEER
                </h3>
        ...
        {/* ── PDF Download ───────────────────────────────────────────── */}
        <motion.div whileHover={buttonVar.hover} whileTap={buttonVar.tap} className="text-center pb-4">
          <a href="/Grant_Polazzo_Resume_2025.pdf" download className="btn btn-primary">
